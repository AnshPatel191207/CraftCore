...
export const translations: Record<string, any> = {
  ...
  "soilAnalysisPortalSub": { en: "Machine Learning Analysis • Field Optimization Protocols", hi: "मशीन लर्निंग विश्लेषण • क्षेत्र अनुकूलन प्रोटोकॉल", gu: "મશીન લર્નિંગ એનાલિસિસ • ફિલ્ડ ઓપ્ટિમાઇઝેશન પ્રોટોકોલ" },
  "uploadReport": { en: "Initialize Soil Scan", hi: "मिट्टी स्कैन प्रारंभ करें", gu: "સોઈલ સ્કેન શરૂ કરો" },
  "dropPdf": { en: "Drag & drop field reports, or click to browse", hi: "फील्ड रिपोर्ट खींचें और छोड़ें, या ब्राउज़ करने के लिए क्लिक करें", gu: "રિપોર્ટ ખેંચો અને છોડો, અથવા બ્રાઉઝ કરવા માટે ક્લિક કરો" },
  "resultsFor": { en: "Analysis Results", hi: "विश्लेषण परिणाम", gu: "એનાલિસિસ પરિણામો" },
  "analyses": { en: "Analyses", hi: "विश्लेषण", gu: "વિશ્લેષણો" },
  "uploadFile": { en: "Upload File", hi: "फ़ाइल अपलोड करें", gu: "ફાઈલ અપલોડ કરો" },
  "ocrImage": { en: "OCR Scan", hi: "ओसीआर स्कैन", gu: "OCR સ્કેન" },
  "manualEntry": { en: "Manual Entry", hi: "मैनुअल प्रविष्टि", gu: "મેન્યુઅલ એન્ટ્રી" },
  "manualEntrySub": { en: "Enter your soil laboratory results", hi: "अपने मिट्टी प्रयोगशाला परिणाम दर्ज करें", gu: "તમારા સોઈલ લેબોરેટરી પરિણામો દાખલ કરો" },
  "closeScan": { en: "Close Scan", hi: "स्कैन बंद करें", gu: "સ્કેન બંધ કરો" },
  "viewProtocol": { en: "View Protocol", hi: "प्रोटोकॉल देखें", gu: "પ્રોટોકોલ જુઓ" },
  ...
  "analyzeWithAI": { en: "Analyze with AI", hi: "एआई के साथ विश्लेषण करें", gu: "AI સાથે એનાલિસિસ કરો" },
  "advisory": {
  ...
  "Sandy": { en: "Sandy", hi: "रेतीली", gu: "રેતાળ" },
  "Loamy": { en: "Loamy", hi: "दोमट", gu: "ગોરાડુ" },
  "Clay": { en: "Clay", hi: "मृण्मय (चिकनी)", gu: "કાળી ચીકણી" },
  "Sandy Loam": { en: "Sandy Loam", hi: "बलुई दोमट", gu: "રેતાળ ગોરાડુ" },
  "Silt Loam": { en: "Silt Loam", hi: "सिल्ट दोमट", gu: "કાંપવાળી ગોરાડુ" },
