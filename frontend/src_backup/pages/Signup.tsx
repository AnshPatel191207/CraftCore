              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 bg-white/5 border border-white/10 rounded-xl hover:bg-teal-500/10 hover:border-teal-500/30 transition-all text-white font-bold text-[10px] uppercase tracking-widest"
                  >
                  ...
                  <button
                    type="button"
                    disabled
                    className="flex items-center justify-center gap-2 py-3 bg-white/5 border border-white/10 rounded-xl opacity-40 cursor-not-allowed text-white font-bold text-[10px] uppercase tracking-widest"
                  >
                    <Github size={18} />
                    GITHUB
                  </button>
