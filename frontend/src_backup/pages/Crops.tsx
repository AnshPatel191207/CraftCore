...
const COLORS = ['var(--primary)', 'var(--success)', 'var(--accent)', 'var(--info)', 'var(--warning)'];
      ...
      <AnimatePresence mode="wait">
        {showForm ? (
          <motion.div 
            ...
            className="bg-surface-2/80 backdrop-blur-lg border border-border rounded-3xl p-8 max-w-2xl mx-auto shadow-2xl relative"
          >
            {crops.length > 0 && (
              <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="e.g. 120"
                    className="w-full bg-surface-3 border border-border rounded-xl px-4 py-3 text-text focus:border-primary/50 outline-none transition-all"
                    required
                  />
                </div>
                <div className="space-y-2">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {displayCrops.map((crop, i) => {
                ...
                // Health Color Logic
                const healthColor = crop.health >= 80 ? 'var(--success)' : crop.health >= 50 ? 'var(--warning)' : 'var(--error)';
