...
function CircleGauge({ value }: { value: number }) {
  ...
  return (
    <svg width="64" height="64" viewBox="0 0 52 52" className="drop-shadow-[0_0_8px_rgba(34,197,94,0.2)]">
      <circle cx="26" cy="26" r={r} fill="none" stroke="var(--primary-dim)" strokeWidth="4" />
      <motion.circle
      ...
      <text x="26" y="30" textAnchor="middle"
        fontSize="10" fill="var(--primary)" fontWeight="black" className="font-display">
        {value}%
      </text>
    </svg>
  );
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] py-20 px-8">
        <motion.div
          ...
          className="bg-surface-2 backdrop-blur-lg border border-border rounded-[40px] p-12 max-w-xl w-full text-center shadow-2xl relative overflow-hidden"
        >
          <div className="absolute -top-24 -right-24 w-64 h-64 bg-primary-dim rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-primary-dim/10 rounded-full blur-[100px] pointer-events-none" />

          <div className="w-24 h-24 rounded-[32px] bg-primary-dim flex items-center justify-center mx-auto mb-8 text-primary relative z-10 border border-primary/20 shadow-xl">
            <LayoutDashboard size={48} />
          </div>

          <h2 className="text-4xl font-display font-black text-text mb-4 relative z-10">
            {t('welcomeToDashboard') || 'Welcome to Dashboard'}
          </h2>
          <p className="text-text-muted mb-10 text-lg leading-relaxed relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 relative z-10">
            <button
              ...
              className="flex-1 py-4 bg-primary text-bg rounded-2xl font-black uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-xl shadow-primary/20"
            >
              <TrendingUp size={20} />
            ...
            <button
              onClick={handleDummy}
              className="flex-1 py-4 bg-primary-dim text-primary border border-primary/30 rounded-2xl font-black uppercase tracking-widest hover:bg-primary/10 transition-all flex items-center justify-center gap-3"
            >
              <Sprout size={20} />
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <ScrollReveal direction="right" duration={0.6}>
          <motion.div variants={fadeUp} className="flex items-center gap-3">
            <div className="px-4 py-2 rounded-xl glass border border-primary-dim flex items-center gap-2 group cursor-pointer hover:border-primary/40 transition-all">
              <Globe size={14} className="text-primary" />
              <span className="text-xs font-black text-text uppercase tracking-widest">{t('globalSync')}</span>
              <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
            </div>
            <div className="p-2.5 glass border border-border rounded-xl cursor-pointer hover:bg-primary-dim transition-colors">
      ...
      <ScrollReveal direction="down" duration={0.6}>
        ...
        >
          <div className="flex items-center gap-1.5">
            ...
            <span style={{ color: 'var(--primary)' }}>{t('live')}</span>
          </div>
      ...
      <ScrollReveal direction="left">
        ...
        >
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-4 relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-primary-dim backdrop-blur-md rounded-full border border-primary/20 max-w-fit">
          ...
          <div className="hidden md:flex flex-shrink-0 w-[200px] flex-col items-center gap-3 relative z-10">
            ...
            <div className="text-center">
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-3xl font-display font-black text-primary">{avgHealth}</span>
      ...
      <ScrollReveal direction="up" delay={0.2}>
        ...
        >
          ...
          <button
            ...
            className="relative z-10 px-8 py-4 rounded-2xl bg-primary text-bg font-black text-sm uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl flex items-center gap-2 group"
          >
            {t('openAIAdvisor')}
