...
export const translations: Record<string, any> = {
  ...
  "clear": { en: "Clear", hi: "साफ", gu: "ચોખ્ખું" },
  ...
  "soilAnalysisPortalSub": { en: "Upload reports or enter data to get AI-powered insights.", hi: "एआई-संचालित अंतर्दृष्टि प्राप्त करने के लिए रिपोर्ट अपलोड करें या डेटा दर्ज करें।", gu: "AI-સંચાલિત આંતરદૃષ્ટિ મેળવવા માટે રિપોર્ટ અપલોડ કરો અથવા ડેટા દાખલ કરો." },
  "uploadReport": { en: "Upload Report", hi: "रिपोर्ट अपलोड करें", gu: "રિપોર્ટ અપલોડ કરો" },
  "dropPdf": { en: "Drop PDF here", hi: "पीडीएफ यहां डालें", gu: "પીડીએફ અહીં મૂકો" },
  "resultsFor": { en: "Results for", hi: "के लिए परिणाम", gu: "માટે પરિણામો" },
  "UPLOADFILE": { en: "Upload File", hi: "फ़ाइल अपलोड करें", gu: "ફાઇલ અપલોડ કરો" },
  "OCRIMAGE": { en: "OCR Image", hi: "ओसीआर इमेज", gu: "OCR ઈમેજ" },
  "MANUALENTRY": { en: "Manual Entry", hi: "मैनुअल प्रविष्टि", gu: "મેન્યુઅલ એન્ટ્રી" },
  "SUPPORTSPDFJPEG": { en: "Supports PDF, JPG, PNG", hi: "पीडीएफ, जेपीजी, पीएनजी का समर्थन करता है", gu: "PDF, JPG, PNG સપોર્ટ કરે છે" },
  "soilHealth": {
