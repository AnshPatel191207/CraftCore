      ...
      <AnimatePresence>
        {isListening && (
          <motion.div
            ...
            className="bg-surface/80 backdrop-blur-xl border border-teal-500/30 rounded-2xl p-4 mb-2 shadow-2xl min-w-[200px]"
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] font-black text-teal-500 uppercase tracking-widest">Listening...</span>
            </div>
            <p className="text-text font-bold text-sm leading-tight italic">
        ...
        {showSettings && (
          <motion.div
            ...
            className="bg-surface/90 backdrop-blur-xl border border-border rounded-2xl p-4 mb-2 shadow-2xl flex gap-2"
          >
