      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {features.map((feature, i) => (
          <ScrollReveal key={i} direction={i % 2 === 0 ? 'left' : 'right'} delay={0.1}>
            <div className="group relative h-full p-8 glass border border-white/10 rounded-[40px] hover:border-teal-500/30 transition-all overflow-hidden">
          ...
          <div className="glass border border-white/10 rounded-[40px] p-8 space-y-6 h-full">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm font-medium focus:outline-none focus:border-teal-500/50 transition-all placeholder:text-text-muted text-white"
              />
              <button 
                onClick={handleAskAI}
