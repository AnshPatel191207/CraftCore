            ...
            >
              ...
              <div className="space-y-8 relative z-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button className="flex items-center justify-center gap-2 py-3 bg-surface-2 border border-border rounded-xl hover:border-teal-500/30 transition-all text-text font-bold text-[10px] uppercase tracking-widest">
