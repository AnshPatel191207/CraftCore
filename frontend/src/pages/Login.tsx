            ...
            <div className="bg-green-900/40 backdrop-blur-xl border border-green-700/30 rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/50">
              <div className="space-y-8">
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-green-500 hover:bg-green-400 text-bg font-black rounded-2xl transition-all shadow-xl shadow-green-500/20 active:scale-[0.98] flex items-center justify-center gap-3 mt-4"
                  >
                    <LogIn size={20} />
                    LAUNCH DASHBOARD
                  </button>
