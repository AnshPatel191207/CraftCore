    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <motion.div variants={fadeUp} className="flex items-center gap-3">
          <div className="px-4 py-2 rounded-xl glass border border-teal-dim flex items-center gap-2 cursor-pointer hover:border-teal-500/40 transition-all">
      ...
      >
        ...
        <div className="relative z-10 text-center md:text-left">
          ...
          <p className="text-text-muted font-bold max-w-md">
            Get personalized yield optimization strategies based on your unique soil profile.
          </p>
        </div>
