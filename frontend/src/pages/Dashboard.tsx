...
export default function Dashboard() {
  const { crops, advisories, farmName, totalAcres, currentDomain, setPanelOpen, setActivePage } = useFarmStore();
  const { t } = useLanguage();
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] py-20 px-8">
        ...
        >
          ...
          <h2 className="text-4xl font-display font-black text-white mb-4 relative z-10">Welcome to Dashboard</h2>
          <p className="text-white/50 mb-10 text-lg leading-relaxed relative z-10">
            Select your farm data source to begin monitoring your field intelligence.
          </p>
