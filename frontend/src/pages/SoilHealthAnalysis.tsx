...
const PARAMETER_MAP = [
  { id: 'nitrogen', icon: Leaf, color: '#22c55e', baseKey: 'n' },
  { id: 'phosphorus', icon: FlaskConical, color: '#3b82f6', baseKey: 'p' },
  { id: 'potassium', icon: Activity, color: '#f59e0b', baseKey: 'k' },
...
export default function SoilHealthAnalysis() {
  ...
  const getStatusConfig = (score: number) => {
    ...
    if (score >= 50) return { 
      ...
      icon: '⚠️', 
      classes: 'bg-yellow-500/20 text-yellow-500', 
      color: '#eab308',
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {PARAMETER_MAP.map((p, i) => {
          ...
          if (p.id === 'carbon' && val < 3) pStatus = { label: 'Moderate', classes: 'bg-yellow-500/20 text-yellow-500', icon: '⚠️' };
            ...
            <ScrollReveal direction="left">
               <div className={`p-8 rounded-[32px] border border-red-500/10 bg-red-500/5 relative overflow-hidden group shadow-[0_0_30px_rgba(239,68,68,0.1)]`}>
                  ...
                  <div className="flex items-center gap-4 mb-8">
                     <div className="w-12 h-12 rounded-2xl bg-red-500 flex items-center justify-center text-bg shadow-[0_0_20px_rgba(239,68,68,0.4)]">
                        <AlertCircle size={24} />
                     </div>
            ...
            <ScrollReveal direction="up">
               <div className="p-10 rounded-[40px] border border-white/10 bg-gradient-to-br from-teal-500/5 to-transparent relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-12">
                      <div className="w-12 h-12 rounded-2xl bg-teal-500 flex items-center justify-center text-bg shadow-[0_0_20px_rgba(20,184,166,0.3)]">
                        <TrendingUp size={24} />
                      </div>
