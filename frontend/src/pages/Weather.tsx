  ...
  return (
    <div className="space-y-6">
      ...
      <ScrollReveal direction="up" delay={0.1}>
        <div className="relative rounded-2xl overflow-hidden glass border border-earth-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <ScrollReveal direction={i % 2 === 0 ? 'left' : 'right'} delay={0.2 + i * 0.05} key={item.label}>
            <div className="glass-card rounded-2xl p-4 border border-earth-200 text-center h-full">
      ...
      <ScrollReveal direction="left" delay={0.3}>
        <div className="glass-card rounded-2xl p-6 border border-earth-200">
      ...
      <ScrollReveal direction="up" delay={0.5}>
        <div className="rounded-2xl p-6 leaf-gradient text-white">
