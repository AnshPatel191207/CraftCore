...
import {
  ...
  Beaker, Droplets, Leaf, FlaskConical, Eye, ChevronRight,
} from 'lucide-react';
      ...
      <div className="pt-8 mt-6 border-t border-white/5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col items-center p-6 rounded-3xl glass border border-white/5">
            ...
            <p className="text-[10px] font-black text-text-muted mt-1">Scientific pH: {r.ph}</p>
          </div>
          ...
          <div>
            <p className="text-[10px] font-black text-text-muted uppercase tracking-widest px-1 mb-4">
              Protocol Adjustments
            </p>
...
export default function SoilReports() {
  ...
  // Demo simulation — mirrors backend response shape
    ...
    <div className="space-y-10 pb-20">
      ...
      <motion.div variants={fadeUp} initial="hidden" animate="visible">
        ...
        <p className="text-text-muted font-bold uppercase tracking-[0.2em] text-[10px]">
          Machine Learning Analysis • Field Optimization Protocols
        </p>
      </motion.div>
              ...
              >
                <div className="flex items-center gap-6 relative z-10">
                  ...
                  <div className={cn(
                    ...
                    {report.status === 'processing' ? <Loader2 className="animate-spin" size={24} />  :
                     report.status === 'complete'   ? <FileText size={24} />                          :
                                                      <AlertCircle size={24} />}
                  </div>
