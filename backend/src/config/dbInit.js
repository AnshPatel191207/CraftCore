            ...
            await SoilReport.insertMany([
                {
                    ...
                    fileUrl: 'https://example.com/seed/field_a_soil_test.pdf',
                    fileType: 'pdf',
                ...
                },
                {
                    ...
                    fileUrl: 'https://example.com/seed/field_b_analysis.pdf',
                    fileType: 'pdf',
                    ...
                    results: {
                        ...
                        recommendations: [
                            'Soil pH is too acidic. Apply agricultural lime.',
                            'Nitrogen is deficient. Increase urea application by 25%.',
                            'Organic matter is low. Add farmyard manure.'
                        ]
                    }
                }
            ]);
